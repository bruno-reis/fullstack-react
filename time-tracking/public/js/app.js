...
class EditableTimerList extends React.Component {
  render() {
    const timers = this.props.timers.map(timer => (
      <EditableTimer key={timer.key} title={timer.title} project={timer.project}
...
class EditableTimer extends React.Component {
  ...
  render() {
    if (this.editFormOpen) {
      ...
      return (
        <Timer id={this.props.id} title={this.props.title} project={this.props.project}
               elapsed={this.props.elapsed} runningSince={this.props.runningSince}
        />
      )
    }
  }
...
class ToggleableTimerForm extends React.Component {
  ...
  render() {
    if (this.state.isOpen) return ( <TimerForm />)
    else {
      return (
